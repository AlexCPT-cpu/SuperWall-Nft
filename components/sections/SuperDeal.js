...
const SuperDeal = () => {
  return (
    <div className='mt-11 items-center text-center'>
        ...
        <div className='mt-4 relative'>
            ...
            <div className='absolute text-sm top-12 md:top-28 md:left-32 items-center px-4'>
                ...
                <ol className='text-xs md:text-xs'>
                    <li className='text-xs md:text-sm'><span>Super Pass Must be Delisted or listed above 1 Eth.</span></li>
                    <li className='text-xs md:text-sm'>1st snapshot of holders will be taken two weeks after Mint.</li>
                    <li className='text-xs md:text-sm'>2nd snapshot of holders to be taken before GEB mint.</li>
                    <li className='text-xs md:text-sm'>If a Super Pass is bought from the Secondary Market,<br /> the holder will be able to claim a OG Role for GEB and receive a 50% Discouunt during mint.</li>
                </ol>
